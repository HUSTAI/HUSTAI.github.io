import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as r,c as l,e as o,a as n,b as e,d as s,f as a}from"./app-eeb0ab6e.js";const u={},v=n("h1",{id:"prompt工程指南",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#prompt工程指南","aria-hidden":"true"},"#"),e(" Prompt工程指南")],-1),c=n("p",null,"Prompt工程是一种创新的自然语言生成技术，同时是一门比较新的学科。Prompt指通过提供简短的指令或问题，启发机器生成连贯的文本回复。Prompt工程通过开发和优化Prompt，从而有效地将语言模型 （LM） 用于各种应用程序和研究主题（如问答和算术推理）。",-1),m={href:"https://github.com/dair-ai/Prompt-Engineering-Guide",target:"_blank",rel:"noopener noreferrer"},h=a(`<hr><h2 id="_1-基础prompt" tabindex="-1"><a class="header-anchor" href="#_1-基础prompt" aria-hidden="true">#</a> 1 基础Prompt</h2><h3 id="_1-1-文本摘要" tabindex="-1"><a class="header-anchor" href="#_1-1-文本摘要" aria-hidden="true">#</a> 1.1 文本摘要</h3><p>抗生素介绍文本简化，将大段的文本精简为一段话。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Prompt:
...
Output:
Adding all the odd numbers (15, 5, 13, 7, 1) gives 41. The answer is False.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-zero-shot-思维链" tabindex="-1"><a class="header-anchor" href="#_2-4-zero-shot-思维链" aria-hidden="true">#</a> 2.4 Zero-shot 思维链</h3>`,4),x={href:"https://arxiv.org/abs/2205.11916",target:"_blank",rel:"noopener noreferrer"},T=a(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Prompt:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当没有太多example可用于prompt时，这特别有用。</p><h3 id="_2-5-自洽性" tabindex="-1"><a class="header-anchor" href="#_2-5-自洽性" aria-hidden="true">#</a> 2.5 自洽性</h3>`,5),_={href:"https://arxiv.org/pdf/2203.11171.pdf",target:"_blank",rel:"noopener noreferrer"},P=a(`<p>这个想法是通过 few-shot CoT 对多个不同的推理路径进行采样，并使用生成来选择最一致的答案。 这有助于提高 CoT 提示在涉及算术和常识推理的任务上的性能。</p><p>首先用下面的例子来进行算术推理：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Prompt:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个例子发生了一些非常有趣的事情。 在第一个答案中，模型非常自信，但在第二个答案中就没那么自信了。</p><p>出于演示目的，过程有所简化，但在得出最终答案时需要考虑的细节很少。 具体信息见于之前的论文。</p><h3 id="_2-7-自动提示工程师" tabindex="-1"><a class="header-anchor" href="#_2-7-自动提示工程师" aria-hidden="true">#</a> 2.7 自动提示工程师</h3><p>Zhou et al(2022) 提出了自动提示工程师 (automatic prompt engineer，APE) 自动指令生成和选择的框架。 指令生成问题被定义为自然语言合成，作为黑盒优化问题使用 LLM 生成和搜索候选解决方案。</p><p>第一步涉及一个大型语言模型（作为推理模型），该模型提供输出演示以生成任务的候选指令。 这些候选解决方案将指导搜索过程。 使用目标模型执行指令，然后根据计算的评估分数选择最合适的指令。</p><p>APE 发现了一个比人工设计的“让我们一步步思考”提示更好的零样本 CoT 提示（Kojima 等人，2022）。</p><p>这篇文章涉及提示工程相关的一个重要主题，即自动优化提示的想法。这里有几篇重要论文：</p>`,20),q={href:"https://arxiv.org/abs/2010.15980",target:"_blank",rel:"noopener noreferrer"},A={href:"https://arxiv.org/abs/2101.00190",target:"_blank",rel:"noopener noreferrer"},O={href:"https://arxiv.org/abs/2104.08691",target:"_blank",rel:"noopener noreferrer"},Y=a(`<h2 id="_3-prompt应用" tabindex="-1"><a class="header-anchor" href="#_3-prompt应用" aria-hidden="true">#</a> 3 Prompt应用</h2><p>在该小节中，我们应用prompt工程来解决更进阶的问题。</p><p>PAL (Program-Aided Language Models): Code as Reasoning</p><p>Gao 等人 (2022) 提出了一种使用 LLM 阅读自然语言问题并生成程序作为中间推理步骤的方法。 创造的程序辅助语言模型 (PAL)，它与思维链提示的不同之处在于，它不是使用自由格式的文本来获取解决方案，而是将解决方案步骤卸载到编程运行时，例如 Python 解释器。</p><figure><img src="https://github.com/dair-ai/Prompt-Engineering-Guide/blob/main/img/pal.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>question = &quot;Today is 27 February 2023. I was born exactly 25 years ago. What is the date I was born in MM/DD/YYYY?&quot;
...
Text: &quot;Watching TV makes me happy.&quot;
Label: Positive
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,21);function L(N,M){const i=d("ExternalLinkIcon");return r(),l("div",null,[v,c,o(" more "),n("p",null,[e("代码地址："),n("a",m,[e("https://github.com/dair-ai/Prompt-Engineering-Guide"),s(i)])]),h,n("p",null,[e("根据 "),n("a",b,[e("Min 等人的研究结果 (2022)"),s(i)]),e("，这里有一些关于在做few-shots时的"),p,e(" / "),g,e(" 的提示：")]),f,n("p",null,[e("在"),n("a",y,[e("Wei 等人的研究(2022)"),s(i)]),e("中，思想链 (CoT) 提示通过中间推理步骤启用复杂的推理能力。 可以将它与少量prompt结合使用，以便在响应前需要推理的更复杂任务中获得更好的结果。")]),w,n("p",null,[e("最近出现的一个想法是"),n("a",x,[e("零样本 CoT（Kojima 等人，2022 年）"),s(i)]),e("的想法，它主要涉及在原始提示中添加“让我们逐步思考”。 让我们尝试一个简单的问题，看看模型的表现如何：")]),T,n("p",null,[e("自洽性可能是用于prompt工程的先进技术之一。由"),n("a",_,[e("Wang 等人 (2022)"),s(i)]),e("提出，自洽性（Self-Consistency）旨在“取代思维链prompt中使用的朴素贪心解码”(to replace the naive greedy decoding used in chain-of-thought prompting)。")]),P,n("p",null,[e("整合知识或信息以帮助模型更准确预测是一种流行的技术， "),n("a",k,[e("Liu 等人在论文（2022）"),s(i)]),e("中尝试使用类似的想法，该模型是否也可以用于在进行预测之前生成知识？ 生成知识以用作提示的一部分。")]),I,n("ul",null,[n("li",null,[n("a",q,[e("AutoPrompt"),s(i)]),e(" - 提出了一种基于梯度引导搜索自动为各种任务创建提示的方法。")]),n("li",null,[n("a",A,[e("Prefix Tuning"),s(i)]),e(" - 微调的一种轻量级替代方法，它为 NLG 任务添加了可训练的连续前缀。")]),n("li",null,[n("a",O,[e("Prompt Tuning"),s(i)]),e(" - 提出了一种通过反向传播学习软提示的机制。")])]),Y])}const W=t(u,[["render",L],["__file","PromptEngineeringGuide.html.vue"]]);export{W as default};
