import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as r,c as l,e as o,a as e,b as n,d as a,f as s}from"./app-e8203f25.js";const u={},v=e("h1",{id:"prompt工程指南",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#prompt工程指南","aria-hidden":"true"},"#"),n(" Prompt工程指南")],-1),c=e("p",null,"Prompt工程是一种创新的自然语言生成技术，同时是一门比较新的学科。Prompt指通过提供简短的指令或问题，启发机器生成连贯的文本回复。Prompt工程通过开发和优化Prompt，从而有效地将语言模型 （LM） 用于各种应用程序和研究主题（如问答和算术推理）。",-1),m={href:"https://github.com/dair-ai/Prompt-Engineering-Guide",target:"_blank",rel:"noopener noreferrer"},h=s(`<hr><h2 id="_1-基础prompt" tabindex="-1"><a class="header-anchor" href="#_1-基础prompt" aria-hidden="true">#</a> 1 基础Prompt</h2><h3 id="_1-1-文本摘要" tabindex="-1"><a class="header-anchor" href="#_1-1-文本摘要" aria-hidden="true">#</a> 1.1 文本摘要</h3><p>抗生素介绍文本简化，将大段的文本精简为一段话。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Prompt:
...
Output:
Negative
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>总的来说，提供examplar似乎在某些地方很有用。 当zero-shot prompting和few-shot prompting不够时，这可能意味着模型学到的任何东西都不足以完成任务。 建议从这里开始考虑微调您自己的模型。</p><h3 id="_2-3-思维链-prompt" tabindex="-1"><a class="header-anchor" href="#_2-3-思维链-prompt" aria-hidden="true">#</a> 2.3 思维链 Prompt</h3>`,7),y={href:"https://arxiv.org/abs/2201.11903",target:"_blank",rel:"noopener noreferrer"},w=s(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Prompt:
The odd numbers in this group add up to an even number: 4, 8, 9, 15, 12, 2, 1.
...
Output:
Adding all the odd numbers (15, 5, 13, 7, 1) gives 41. The answer is False.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-zero-shot-思维链" tabindex="-1"><a class="header-anchor" href="#_2-4-zero-shot-思维链" aria-hidden="true">#</a> 2.4 Zero-shot 思维链</h3>`,4),x={href:"https://arxiv.org/abs/2205.11916",target:"_blank",rel:"noopener noreferrer"},T=s(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Prompt:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当没有太多example可用于prompt时，这特别有用。</p><h3 id="_2-5-自洽性" tabindex="-1"><a class="header-anchor" href="#_2-5-自洽性" aria-hidden="true">#</a> 2.5 自洽性</h3>`,5),_={href:"https://arxiv.org/pdf/2203.11171.pdf",target:"_blank",rel:"noopener noreferrer"},P=s(`<p>这个想法是通过 few-shot CoT 对多个不同的推理路径进行采样，并使用生成来选择最一致的答案。 这有助于提高 CoT 提示在涉及算术和常识推理的任务上的性能。</p><p>首先用下面的例子来进行算术推理：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Prompt:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最终答案的计算涉及几个步骤（详见论文），但为了简单起见，我们可以清楚地看到已经出现了多数答案，因此这基本上成为了最终答案。</p><h3 id="_2-6-知识生成-prompt" tabindex="-1"><a class="header-anchor" href="#_2-6-知识生成-prompt" aria-hidden="true">#</a> 2.6 知识生成 Prompt</h3>`,8),k={href:"https://arxiv.org/pdf/2110.08387.pdf",target:"_blank",rel:"noopener noreferrer"},I=s(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Prompt:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个例子发生了一些非常有趣的事情。 在第一个答案中，模型非常自信，但在第二个答案中就没那么自信了。</p><p>出于演示目的，过程有所简化，但在得出最终答案时需要考虑的细节很少。 具体信息见于之前的论文。</p><h3 id="_2-7-自动提示工程师" tabindex="-1"><a class="header-anchor" href="#_2-7-自动提示工程师" aria-hidden="true">#</a> 2.7 自动提示工程师</h3><p>Zhou et al(2022) 提出了自动提示工程师 (automatic prompt engineer，APE) 自动指令生成和选择的框架。 指令生成问题被定义为自然语言合成，作为黑盒优化问题使用 LLM 生成和搜索候选解决方案。</p><p>第一步涉及一个大型语言模型（作为推理模型），该模型提供输出演示以生成任务的候选指令。 这些候选解决方案将指导搜索过程。 使用目标模型执行指令，然后根据计算的评估分数选择最合适的指令。</p><p>APE 发现了一个比人工设计的“让我们一步步思考”提示更好的零样本 CoT 提示（Kojima 等人，2022）。</p><p>这篇文章涉及提示工程相关的一个重要主题，即自动优化提示的想法。这里有几篇重要论文：</p>`,20),A={href:"https://arxiv.org/abs/2010.15980",target:"_blank",rel:"noopener noreferrer"},q={href:"https://arxiv.org/abs/2101.00190",target:"_blank",rel:"noopener noreferrer"},L={href:"https://arxiv.org/abs/2104.08691",target:"_blank",rel:"noopener noreferrer"},Y=s(`<h2 id="_3-prompt应用" tabindex="-1"><a class="header-anchor" href="#_3-prompt应用" aria-hidden="true">#</a> 3 Prompt应用</h2><p>在该小节中，我们应用prompt工程来解决更进阶的问题。</p><p>PAL (Program-Aided Language Models): Code as Reasoning</p><p>Gao 等人 (2022) 提出了一种使用 LLM 阅读自然语言问题并生成程序作为中间推理步骤的方法。 创造的程序辅助语言模型 (PAL)，它与思维链提示的不同之处在于，它不是使用自由格式的文本来获取解决方案，而是将解决方案步骤卸载到编程运行时，例如 Python 解释器。</p><figure><img src="//assets/images/prompt/PromptEngineeringGuide_01.png" alt="图3.1 PAL模型处理过程示例" tabindex="0" loading="lazy"><figcaption>图3.1 PAL模型处理过程示例</figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>question = &quot;Today is 27 February 2023. I was born exactly 25 years ago. What is the date I was born in MM/DD/YYYY?&quot;
...
Text: &quot;Watching TV makes me happy.&quot;
Label: Positive
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-参考" tabindex="-1"><a class="header-anchor" href="#_5-参考" aria-hidden="true">#</a> 5 参考</h2>`,22),O={href:"https://github.com/dair-ai/Prompt-Engineering-Guide",target:"_blank",rel:"noopener noreferrer"},M=e("p",null,"[2] Sewon Min, Xinxi Lyu, Ari Holtzman, Mikel Artetxe, Mike Lewis, Hannaneh Hajishirzi, et al. Rethinking the Role of Demonstrations: What Makes In-Context Learning Work? arXiv, 2022",-1),E=e("p",null,"[3] Jason Wei, Xuezhi Wang, Dale Schuurmans, Maarten Bosma, Brian Ichter, Fei Xia, et al. Chain-of-Thought Prompting Elicits Reasoning in Large Language Models. arXiv, 2023",-1),S=e("p",null,"[4] Takeshi Kojima, Shixiang Shane Gu, Machel Reid, Yutaka Matsuo, Yusuke Iwasawa. Large Language Models are Zero-Shot Reasoners. arXiv, 2022",-1),N=e("p",null,"[5] Xuezhi Wang, Jason Wei, Dale Schuurmans, Quoc Le, Ed Chi, Sharan Narang, et al. Self-Consistency Improves Chain of Thought Reasoning in Language Models. arXiv, 2022",-1),W=e("p",null,"[6] Jiacheng Liu, Alisa Liu, Ximing Lu, Sean Welleck, Peter West, Ronan Le Bras, et al. Generated Knowledge Prompting for Commonsense Reasoning. arXiv, 2022",-1),C=e("p",null,"[7] Taylor Shin, Yasaman Razeghi, Robert L. Logan IV, Eric Wallace, Sameer Singh. AutoPrompt: Eliciting Knowledge from Language Models with Automatically Generated Prompts. arXiv, 2020",-1),D=e("p",null,"[8] Xiang Lisa Li, Percy Liang. Prefix-Tuning: Optimizing Continuous Prompts for Generation. arXiv, 2021",-1),H=e("p",null,"[9] Brian Lester, Rami Al-Rfou, Noah Constant. The Power of Scale for Parameter-Efficient Prompt Tuning. arXiv, 2021",-1);function F(G,R){const i=d("ExternalLinkIcon");return r(),l("div",null,[v,c,o(" more "),e("p",null,[n("代码地址："),e("a",m,[n("https://github.com/dair-ai/Prompt-Engineering-Guide"),a(i)])]),h,e("p",null,[n("根据 "),e("a",b,[n("Min 等人的研究结果 (2022)"),a(i)]),n("，这里有一些关于在做few-shots时的"),p,n(" / "),g,n(" 的提示：")]),f,e("p",null,[n("在"),e("a",y,[n("Wei 等人的研究(2022)"),a(i)]),n("中，思想链 (CoT) 提示通过中间推理步骤启用复杂的推理能力。 可以将它与少量prompt结合使用，以便在响应前需要推理的更复杂任务中获得更好的结果。")]),w,e("p",null,[n("最近出现的一个想法是"),e("a",x,[n("零样本 CoT（Kojima 等人，2022 年）"),a(i)]),n("的想法，它主要涉及在原始提示中添加“让我们逐步思考”。 让我们尝试一个简单的问题，看看模型的表现如何：")]),T,e("p",null,[n("自洽性可能是用于prompt工程的先进技术之一。由"),e("a",_,[n("Wang 等人 (2022)"),a(i)]),n("提出，自洽性（Self-Consistency）旨在“取代思维链prompt中使用的朴素贪心解码”(to replace the naive greedy decoding used in chain-of-thought prompting)。")]),P,e("p",null,[n("整合知识或信息以帮助模型更准确预测是一种流行的技术， "),e("a",k,[n("Liu 等人在论文（2022）"),a(i)]),n("中尝试使用类似的想法，该模型是否也可以用于在进行预测之前生成知识？ 生成知识以用作提示的一部分。")]),I,e("ul",null,[e("li",null,[e("a",A,[n("AutoPrompt"),a(i)]),n(" - 提出了一种基于梯度引导搜索自动为各种任务创建提示的方法。")]),e("li",null,[e("a",q,[n("Prefix Tuning"),a(i)]),n(" - 微调的一种轻量级替代方法，它为 NLG 任务添加了可训练的连续前缀。")]),e("li",null,[e("a",L,[n("Prompt Tuning"),a(i)]),n(" - 提出了一种通过反向传播学习软提示的机制。")])]),Y,e("p",null,[n("[1] "),e("a",O,[n("Prompt-Engineering-Guide"),a(i)])]),M,E,S,N,W,C,D,H])}const z=t(u,[["render",F],["__file","PromptEngineeringGuide.html.vue"]]);export{z as default};
