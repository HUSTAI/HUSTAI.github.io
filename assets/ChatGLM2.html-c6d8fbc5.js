import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as r,e as l,a as e,b as n,f as a}from"./app-c5fb9497.js";const t="/assets/images/llm/chatglm2_1.jpg",d="/assets/images/llm/chatglm2_2.png",m={},o=e("h1",{id:"chatglm2架构升级",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#chatglm2架构升级","aria-hidden":"true"},"#"),n(" ChatGLM2架构升级")],-1),c=e("p",null,"ChatGLM2-6B使用了GLM的混合目标函数，经过了 1.4T 中英标识符的预训练与人类偏好对齐训练，评测结果显示，相比于初代模型，ChatGLM2-6B在MMLU（+23%）、CEval（+33%）、GSM8K（+571%）、BBH（+60%）等数据集上的性能取得了大幅度的提升，在同尺寸开源模型中具有较强的竞争力。",-1),u=a(`<p>（1）更强大的性能：基于ChatGLM初代模型的开发经验，官方全面升级了 ChatGLM2-6B 的基座模型。</p><p>（2）更长的上下文：基于FlashAttention技术，官方将基座模型的上下文长度（Context Length）由ChatGLM-6B的2K扩展到了32K，并在对话阶段使用 8K 的上下文长度训练，允许更多轮次的对话。但当前版本的ChatGLM2-6B对单轮超长文档的理解能力有限，官方会在后续迭代升级中着重进行优化。</p><p>（3）更高效的推理：基于Multi-Query Attention技术，ChatGLM2-6B有更高效的推理速度和更低的显存占用：在官方的模型实现下，推理速度相比初代提升了 42%，INT4量化下，6G显存支持的对话长度由1K提升到了8K。</p><p>（4）更开放的协议：ChatGLM2-6B权重对学术研究完全开放，在获得官方的书面许可后，亦允许商业使用。如果您发现官方的开源模型对您的业务有用，官方欢迎您对下一代模型ChatGLM3研发的捐赠。</p><h2 id="_1-基座模型的升级" tabindex="-1"><a class="header-anchor" href="#_1-基座模型的升级" aria-hidden="true">#</a> 1 基座模型的升级</h2><h3 id="_1-1-transformer架构" tabindex="-1"><a class="header-anchor" href="#_1-1-transformer架构" aria-hidden="true">#</a> 1.1 Transformer架构</h3><p>Encoder-Decoder变成Decoder-only。</p><h3 id="_1-2-词汇表大小" tabindex="-1"><a class="header-anchor" href="#_1-2-词汇表大小" aria-hidden="true">#</a> 1.2 词汇表大小</h3><p>130344减小到64794。</p><p>由于抛弃了NLU任务，只保留NLG生成任务，因此不再包含mask token。</p><h3 id="_1-3-模型结构" tabindex="-1"><a class="header-anchor" href="#_1-3-模型结构" aria-hidden="true">#</a> 1.3 模型结构</h3><h4 id="_1-3-1-总体架构" tabindex="-1"><a class="header-anchor" href="#_1-3-1-总体架构" aria-hidden="true">#</a> 1.3.1 总体架构</h4><p>ChatGLM-6B的总体架构如下所示。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;bound method Module.modules of ChatGLMForConditionalGeneration(
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-测试结果" tabindex="-1"><a class="header-anchor" href="#_4-测试结果" aria-hidden="true">#</a> 4 测试结果</h2><figure><img src="`+d+'" alt="示意图" tabindex="0" loading="lazy"><figcaption>图4.1 ChatGLM和ChatGLM2对比</figcaption></figure>',4);function M(L,T){return i(),r("div",null,[o,c,l(" more "),u,h,v,p,b,_,f,y,g,x])}const w=s(m,[["render",M],["__file","ChatGLM2.html.vue"]]);export{w as default};
