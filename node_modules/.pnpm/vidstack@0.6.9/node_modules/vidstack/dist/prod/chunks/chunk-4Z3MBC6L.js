...
var Time = class extends Component {
  onAttach() {
    this.a = useMedia();
    this.Fe = computed(this.Fc.bind(this));
  }
  Fc() {
    const { type, remainder, padHours, padMinutes, showHours } = this.$props, seconds = this.mi(type()), duration = this.a.$store.duration();
  ...
  render() {
    return (() => {
      ...
      $$_insert_at_marker_lite($$_expr, this.Fe);
      return $$_root;
    })();
  }
};
