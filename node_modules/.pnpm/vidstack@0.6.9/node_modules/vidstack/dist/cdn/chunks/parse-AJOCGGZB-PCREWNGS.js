import { VTTCue, parseVTTTimestamp } from './chunk-7SNUKWCT.js';
import './chunk-VPSTUDLO.js';

// ../../node_modules/.pnpm/media-captions@0.0.15/node_modules/media-captions/dist/chunks/parse-AJOCGGZB.js
...
var SSAParser = class {
  ...
  async init(init) {
    this._init = init;
    if (init.errors)
      this._errorBuilder = (await import('./errors-VSYRGBIT-Z7GE3KEM.js')).ParseErrorBuilder;
  }
