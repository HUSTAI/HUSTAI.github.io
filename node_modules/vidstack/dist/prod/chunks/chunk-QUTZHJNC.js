...
var TextTrack = class extends EventsTarget {
  ...
  sd(json, VTTCue, VTTRegion) {
    try {
      ...
      if (json.regions) {
        this.tb = json.regions.map((json2) => Object.assign(new VTTRegion(), json2));
      }
      if (json.cues) {
