...
var TextTrack = class extends EventsTarget {
  ...
  async _load() {
    ...
    try {
      const { parseResponse, VTTCue, VTTRegion } = await import('media-captions'), crossorigin = (_a2 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a2.call(this);
  ...
  _readyState() {
    var _a2;
    this[TEXT_TRACK_READY_STATE] = 2;
    const nativeTrack = (_a2 = this[TEXT_TRACK_NATIVE]) == null ? void 0 : _a2.track;
    if (nativeTrack)
