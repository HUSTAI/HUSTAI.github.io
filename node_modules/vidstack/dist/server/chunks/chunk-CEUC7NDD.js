...
import { TextTrack } from './chunk-SRKDCPIB.js';
...
var VideoProviderLoader = class {
  ...
  async load(context) {
    return new (await import('./provider-UEZKXYXH.js')).VideoProvider(this._video, context);
  }
  render($store) {
...
var _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await import('./provider-4CW4IRFI.js')).HLSProvider(this._video, context);
  }
};
