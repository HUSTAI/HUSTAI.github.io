...
import { TextTrack } from './chunk-OMT72TXU.js';
...
var VideoProviderLoader = class {
  ...
  async load(context) {
    ...
    return new (await import('./provider-4626LWHG.js')).VideoProvider(this._video, context);
  }
  render($store) {
...
var _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./provider-4SEO7LEN.js')).HLSProvider(this._video, context);
  }
};
