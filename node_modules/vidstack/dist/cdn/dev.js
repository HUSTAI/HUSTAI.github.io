import { SET_AUTO_QUALITY, ENABLE_AUTO_QUALITY, coerceToError } from './chunks/chunk-Q2B6ZAYN.js';
import { TEXT_TRACK_CROSSORIGIN, isTrackCaptionKind, findActiveCue, isCueActive, onTrackChapterChange, preconnect, TEXT_TRACK_CAN_LOAD, TEXT_TRACK_UPDATE_ACTIVE_CUES, getRequestCredentials, ATTACH_VIDEO, TEXT_TRACK_NATIVE_HLS, TextTrack, TEXT_TRACK_ON_MODE_CHANGE, TEXT_TRACK_NATIVE } from './chunks/chunk-HCCTCEAI.js';
...
var VideoProviderLoader = class {
  ...
  async load(context) {
    ...
    return new (await import('./chunks/provider-DA3QT66Q.js')).VideoProvider(this._video, context);
  }
  render($store) {
...
var _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./chunks/provider-CYEAFXNC.js')).HLSProvider(this._video, context);
  }
};
