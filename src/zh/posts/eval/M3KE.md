...
一种大规模多层次多主题知识评估基准，旨在衡量中文大型语言模型在零样本和少样本设置中获取知识能力
...
![图1.1 M3KE数据集中任务分布](/assets/images/eval/M3KE_1.png "图1.1 M3KE数据集中任务分布" =300x400)
...
![图2.1 M3KE数据集中任务领域和难度的分布](/assets/images/eval/M3KE_2.png "图2.1 M3KE数据集中任务领域和难度的分布"=500x600)
